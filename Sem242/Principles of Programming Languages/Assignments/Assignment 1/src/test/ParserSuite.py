...
class ParserSuite(unittest.TestCase):
    ...
    def test_004(self):
        ...
        self.assertTrue(
            TestParser.checkParser("const Votien = [1.]ID{1, 3};", "Error on line 1 col 17: 1.", 104)
        )
    ...
    def test_015(self):
        ...
        """
        self.assertTrue(
            TestParser.checkParser(input_str, "Error on line 2 col 33: }", 115)
        )
    ...
    def test_016(self):
        ...
        """
        self.assertTrue(
            TestParser.checkParser(input_str, "Error on line 8 col 36: }", 116)
        )
    ...
    def test_023(self):
        ...
        self.assertTrue(
            TestParser.checkParser("var z VOTIEN = [true]int{1};", "Error on line 1 col 17: true", 123)
        )
    ...
    def test_034(self):
        ...
        self.assertTrue(
            TestParser.checkParser("const a =;", "Error on line 1 col 10: ;", 134)
        )
    ...
    def test_038(self):
        ...
        """
        self.assertTrue(
            TestParser.checkParser(input_str, "Error on line 3 col 23: =", 138)
        )
    ...
    def test_040(self):
        ...
        self.assertTrue(
            TestParser.checkParser("type Calculator interface {Reset()}", "Error on line 1 col 35: }", 140)
        )
    ...
    def test_044(self):
        ...
        self.assertTrue(
            TestParser.checkParser("", "Error on line 1 col 1: <EOF>", 144)
        )
    ...
    def test_049(self):
        ...
        """
        self.assertTrue(
            TestParser.checkParser(input_str, "Error on line 3 col 25: +=", 149)
        )
    ...
    def test_060(self):
        ...
        self.assertTrue(
            TestParser.checkParser("var a;", "Error on line 1 col 6: ;", 160)
        )

    def test_061(self):
        """Error: variable declaration with illegal literal form"""
        self.assertTrue(
            TestParser.checkParser("var a = {1, 2};", "Error on line 1 col 9: {", 161)
        )
    ...
    def test_063(self):
        """Literal: constant float literal with scientific notation"""
        self.assertTrue(
            TestParser.checkParser("const e = 2.71e2;", "successful", 163)
        )
    ...
    def test_100(self):
        """Declaration: main function calling a print function"""
        input_str = """
            func main() {
                Print("Hello");
            }
